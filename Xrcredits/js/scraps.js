...
//      this.form.elements[vs['field']].value=this.options[this.selectedIndex].text;
    ...
    case 'invest-proposal':
      $('#add-co').click(function () {
        var hids = $('.form-item-fullName, .form-item-city, .form-item-serviceArea, .form-item-dob, .form-item-description, .form-item-categories');
        hids.show();
        hids.attr('required', 'yes');
        $('.form-item-company').hide().attr('required', 'no');
        $('#edit-fullname').focus();
      });
      break;
